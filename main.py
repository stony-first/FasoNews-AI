...
# Configuration CORS - Indispensable pour que le frontend puisse parler au backend
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
# Configuration Gemini (Backend Python)
...
async def summarize(article: NewsArticle):
    ...
    try:
        ...
        model = genai.GenerativeModel('gemini-1.5-flash') # En python, on utilise le nom stable
